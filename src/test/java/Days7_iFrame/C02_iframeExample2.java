...
public class C02_iframeExample2 extends BaseTest {
    ...
    public void iframeExample(){
        driver.get("//www.jqueryscript.net/demo/Easy-iFrame-based-Twitter-Emoji-Picker-Plugin-jQuery-Emoojis/");
        driver.switchTo().frame("emoojis");
        WebElement secondEmojiTab=driver.findElement(By.xpath("//a[contains(@href,'nature'"));
        secondEmojiTab.click();

        List<WebElement> emojiList=driver.findElements(By.xpath("//div[@id=mg'nature']//img"));
        emojiList.forEach(WebElement::click);//Her bir img elementine tıklanıyor. Anlamadım

        //Parent frame geri dönünüz.
